    ...
    <main style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "60px 20px" }}>
      <div style={{ width: "100%", maxWidth: 560 }}>
        ...
        <p style={{
          ...
          Upload any image, get AI-generated funny captions, then rate the best ones.
        </p>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <img
              src="/samples/example.svg"
              alt="Example image of a cat sitting on a laptop"
          ...
          <div style={{ display: "grid", gap: 8 }}>
            {[
              "When the code compiles on the first try and you pretend it was on purpose",
              "Day 4 of working from home: the cat has taken over the standup",
              "My face when the deadline was yesterday but the coffee is still warm",
            ].map((caption, i) => (
              <div key={i} style={{
